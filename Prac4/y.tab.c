...
{
  "$end", "error", "$undefined", "ARRAY", "$accept", "expression", YY_NULLPTR
};
#endif
...
yyreduce:
  ...
  switch (yyn)
    {
        case 2:
#line 18 "sorter.y" /* yacc.c:1646  */
    {
			int len;
			int* sorted = split((yyvsp[0].array), &len);
			sort(sorted, len);
			print(sorted, len);
		}
